...
![[img/post-sw-gazebo-step-01-package-tree.png]]
...
![[img/post-sw-gazebo-step-02-urdf-paths.png]]
...
![[img/post-sw-gazebo-step-03-config-folder.png]]
...
![[img/post-sw-gazebo-step-06-world-file.png]]
...
![[img/post-sw-gazebo-step-07-controller-yaml.png]]
编写yaml文件内容：
```yaml
#控制器管理器全局配置
controller_manager:
...
![[img/post-sw-gazebo-step-08-controller-topics.png]]
接下来就可以发布topic了。
```bash
# 发送单个力值 0.5
